...
- Story 3.6 (User Documentation): Will reference Cronos settlement configuration
...
- This story can be developed in parallel with other Epic 3 stories (3.6, 3.7)
...
- Story 3.6: User documentation with IBC bridge flow
