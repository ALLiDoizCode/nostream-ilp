...
- Story 3.6 (User Documentation): Will reference testnet deployment for user guide examples
...
- User documentation with IBC bridge (Story 3.6): Will reference testnet for examples
