...
- This story BLOCKS Story 3.7 (Contract interaction library, which may be merged into this story)
...
From Epic 3 deployment (Story 3.6):
- **Testnet**: Deployed to Akash sandbox-01 testnet
- **Mainnet**: To be deployed in production phase
