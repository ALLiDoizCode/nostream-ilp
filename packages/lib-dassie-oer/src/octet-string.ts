...
export const octetString = (length?: Range<number>) => {
  ...
  if (
    ...
    return new OerFixedOctetString(minimumLength as SafeUnsignedInteger)
  }
  ...
  return new OerVariableOctetString([minimumLength as SafeUnsignedInteger | undefined, maximumLength as SafeUnsignedInteger | undefined])
}
