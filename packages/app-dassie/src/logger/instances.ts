...
export const settlementBase: Logger = createLogger(
  namespaces.LOGGER_SETTLEMENT_BASE,
)
export const settlementBaseMainnet: Logger = createLogger(
  namespaces.LOGGER_SETTLEMENT_BASE_MAINNET,
)
export const settlementCosmos: Logger = createLogger(
  namespaces.LOGGER_SETTLEMENT_COSMOS,
)
export const settlementCronos: Logger = createLogger(
  namespaces.LOGGER_SETTLEMENT_CRONOS,
)
export const settlementLightning: Logger = createLogger(
  namespaces.LOGGER_SETTLEMENT_LIGHTNING,
)
